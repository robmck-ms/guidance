...
class Engine:
    ...
    def __call__(self, parser, grammar, ensure_bos_token=True, **generator_kwargs):
        ...
        while True:
            ...
            if logits_state is not None:
                ...
                logits = self.get_logits(
                    token_ids, forced_bytes, current_temp, **generator_kwargs
                )
...
class Model:
    ...
    def _run_stateless(self, stateless_function, temperature=0.0, top_p=1.0, n=1):
        ...
        gen_obj = self.engine(
            self._current_prompt(), stateless_function, context_variables=self._variables
        )
